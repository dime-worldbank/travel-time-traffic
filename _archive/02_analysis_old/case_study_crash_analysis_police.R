...
lm_hr_coef_df %>%
  dplyr::filter(type %in% "Value - Typical Value",
                data_var %>% str_detect("116|15")) %>%
  make_hourly_fig()

ggsave(filename = file.path(figures_dir, "lm_crash_value_minus_typical_police.png"),
       height = 5, width = 8)
...
ggsave(filename = file.path(figures_dir, "lm_crash_value_police.png"),
       height = 5, width = 8)
...
ggsave(filename = file.path(figures_dir, "lm_crash_value_m_typical_tt_full_police.png"),
       height = 2.5, width = 8)
...
ggsave(filename = file.path(figures_dir, "lm_crash_value_tt_full_police.png"),
       height = 2.5, width = 8)
