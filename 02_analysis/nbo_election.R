...
modelsummary_tab(list("Speed (km)" = lm1,
                 ...
                 escape = FALSE,
                 add_rows = tribble(~term, ~V1, ~V2, ~V3, ~V4, ~V5, ~V6, ~V7, ~V8, ~V9,
                                    'Unit', "Route", "Route", "Route", "Route", "City", "Route", "City", "Route", "City", 
                                    'Route FE', "Y", "Y", "Y", "Y", "N/A", "Y", "N/A", "Y", "N/A",
                                    'Hour FE', "Y", "Y", "Y", "Y", "Y", "Y", "Y", "Y", "Y",
                                    'Day of Week FE', "Y", "Y", "Y", "Y", "Y", "Y", "Y", "Y", "Y"),
